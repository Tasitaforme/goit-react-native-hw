...
Щоб протестувати додаток можете встановити його на своєму Android пристрої:

Є два способи встановлення:

1. Bідкрийте це [посилання](https://expo.dev/accounts/tasita/projects/PhotoProject/builds/19775e43-86a7-47f9-afea-392a0cb94616) на своїх пристроях Android
2. Відскануйте цей QR-код за допомогою Камери свого пристрою. Потім торкніться сповіщення, що з’явиться.
...
> Щоб перевірити, чи залогінені ви вже: `eas whoami`
